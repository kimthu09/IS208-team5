...
import { PageTitleUnderlineType, bienbanItems, phancongItems, sprintPlanningItems, sprintReviewItems } from "@/constants";
        ...
        <div className="flex flex-col gap-16 items-center">
            ...
            <RevealOnScroll className="w-full">
                <div className="flex flex-col gap-8 w-full">
                    ...
                    <Accordion type="multiple" className="w-full hidden md:block">
                        {
                            sprintPlanningItems.map((item, index) => {
                                return (
                                    <AccordionItem key={index} value={`item-${index}`}>
                                        <AccordionTrigger className="text-xl backdrop-blur-sm bg-white/50 px-4 rounded">{item.title}</AccordionTrigger>
                                        <AccordionContent>
            ...
            <RevealOnScroll className="w-full">
                <div className="flex flex-col gap-8 w-full">
                    ...
                    <Accordion type="multiple" className="w-full hidden md:block">
                        {
                            sprintReviewItems.map((item, index) => {
                                return (
                                    <AccordionItem key={index} value={`item-${index}`}>
                                        <AccordionTrigger className="text-xl backdrop-blur-sm bg-white/50 px-4 rounded">{item.title}</AccordionTrigger>
                                        <AccordionContent>
